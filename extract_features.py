...
if __name__ == "__main__":
    model = get_compiled_model(args.model_dir, 
                               ...
                               args.dataset, 
                               args.img_size)
    for img_path in tqdm.tqdm(os.listdir(args.img_dir)):
        # Read in image and convert to NumPy.
        img = image.load_img(os.path.join(args.img_dir, img_path))
        ...
        feature_file_path = os.path.join(args.feature_dir, img_path[:-3] + 'npy')
